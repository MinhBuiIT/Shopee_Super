    ...
    <div className='bg-primary pb-5 pt-3'>
      <div className='container'>
        <div className='flex justify-end'>
          <div className='flex items-end gap-6 text-sm font-light text-white'>
            <Popover
              isScale
              isArrow
              classNameEle='flex cursor-pointer items-center gap-1 hover:opacity-80'
              element={
                <>
                  <svg
            ...
            {!profile ? (
              ...
              <Popover
                isScale
                isArrow
                classNameEle='flex cursor-pointer items-center hover:opacity-80'
                element={
                  <>
        ...
        <div className='mt-4 grid grid-cols-12 place-items-end'>
          <div className='col-span-2'>
            <Link to='/'>
              <svg viewBox='0 0 192 65' fill='#fff' className='w-36'>
                <g fillRule='evenodd'>
